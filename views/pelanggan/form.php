...
if ($mode_edit) {
    ...
    $Pelanggan = $model->getById($_GET['id']);
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                  <h2 class="mb-1">
                    <?php echo $mode_edit ? 'Edit Pelanggan' : 'Tambah Pelanggan'; ?>
                  </h2>
                </div>
                <a href="index.php?controller=pelanggan&action=index" class="btn btn-light btn-icon-text">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title mb-4">
                    <?php echo $mode_edit ? 'Edit Pelanggan' : 'Tambah Pelanggan Baru'; ?>
                  </h4>
                  
                  <form method="POST" action="index.php?controller=pelanggan&action=<?php echo $mode_edit ? 'edit&id='.$_GET['id'] : 'tambah'; ?>">
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="nama_pelanggan" 
                                   name="nama_pelanggan" 
                                   value="<?php echo $mode_edit ? htmlspecialchars($Pelanggan['nama_pelanggan']) : ''; ?>" 
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <textarea 
                                   ...
                                   id="alamat" 
                                   name="alamat" 
                                   placeholder="Masukkan alamat pelanggan"><?php echo $mode_edit ? htmlspecialchars($Pelanggan['alamat']) : ''; ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" 
                                   ...
                                   id="no_hp" 
                                   name="no_hp" 
                                   value="<?php echo $mode_edit ? htmlspecialchars($Pelanggan['no_hp']) : ''; ?>" 
                        ...
                        <div class="form-group mt-4">
                          <div class="d-flex">
                            ...
                            <a href="index.php?controller=pelanggan&action=index" class="btn btn-light btn-icon-text ml-2">
