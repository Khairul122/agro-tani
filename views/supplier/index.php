...
<body>
            ...
            <div class="col-sm-12">
              <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'kasir'): ?>
                  <a href="index.php?controller=supplier&action=tambah" class="btn btn-primary btn-icon-text">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title mb-0">Daftar Supplier</h4>
                    <div class="d-flex">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div>
                                    <h6 class="mb-0"><?php echo htmlspecialchars($item['nama_supplier']); ?></h6>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td>
                                <div class="btn-group" role="group">
                                  <?php if ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'kasir'): ?>
                                    <a href="index.php?controller=supplier&action=edit&id=<?php echo $item['id_supplier']; ?>" 
                                  ...
                                  <?php if ($_SESSION['role'] === 'admin'): ?>
                                    <a href="index.php?controller=supplier&action=hapus&id=<?php echo $item['id_supplier']; ?>" 
                          ...
                          <tr>
                            <td colspan="5" class="text-center py-5">
                              <div class="empty-state">
                                ...
                                <h5 class="mt-3">Tidak ada data supplier</h5>
                                <p>Belum ada supplier yang dibuat</p>
                                <?php if ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'kasir'): ?>
                                  <a href="index.php?controller=supplier&action=tambah" class="btn btn-primary mt-2">Buat Supplier Pertama</a>
                                <?php endif; ?>
                              </div>
                            </td>
                          </tr>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      const searchInput = document.querySelector('input[placeholder="Cari supplier..."]');
      if (searchInput) {
        searchInput.addEventListener('keyup', function() {
          ...
          tableRows.forEach(function(row) {
            const namaSupplier = row.querySelector('h6').textContent.toLowerCase();
            if (namaSupplier.includes(searchTerm)) {
              row.style.display = '';
            } else {
